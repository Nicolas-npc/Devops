...
import { DESPACHOS_API_BASE, VENTAS_API_BASE } from "../../config/api";
...
export const FormDespacho = ({ venta, onClose }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await axios.put(`${VENTAS_API_BASE}/${venta.idVenta}`, jsonDataSales, {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
        },
      });
      await axios.post(DESPACHOS_API_BASE, jsonData, {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
        },
